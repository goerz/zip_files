.PHONY: help clean clean-build clean-pyc clean-test clean-venv flake8-check pylint-check test test35 test36 test37 test38 black-check black isort-check isort coverage test-upload upload release dist dist-check
